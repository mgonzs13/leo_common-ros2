...
def generate_launch_description():
    ...
    tf_args = [
        [
            "--frame-id",
            [tf_prefix, "/", namespace, "_link"],
            "--child-frame-id",
            [tf_prefix, "/", namespace, "_depth_frame"],
            "--y",
            "-0.02",
        ],
        [
            ...
            [tf_prefix, "/", namespace, "_link"],
            "--child-frame-id",
            [tf_prefix, "/", namespace, "_rgb_frame"],
            "--y",
            "-0.045",
        ],
        [
            ...
            [tf_prefix, "/", namespace, "_depth_frame"],
            "--child-frame-id",
            [tf_prefix, "/", namespace, "_depth_optical_frame"],
            "--roll",
            "-1.5707963267948966",
            "--yaw",
            "-1.5707963267948966",
        ...
        [
            ...
            [tf_prefix, "/", namespace, "_rgb_frame"],
            "--child-frame-id",
            [tf_prefix, "/", namespace, "_rgb_optical_frame"],
            "--roll",
            "-1.5707963267948966",
            "--yaw",
            "-1.5707963267948966",
    ...
    return launch.LaunchDescription(
        [namespace_launch_arg, tf_prefix_launch_arg] + tf_nodes
    )
